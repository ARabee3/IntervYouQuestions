...
[ApiController]
public class QuestionOptionsController(IQuestionOptionService questionOptionService) : ControllerBase
{
    private readonly IQuestionOptionService _questionOptionService = questionOptionService;
    ...
    //{
    //    var options = await _questionOptionService.GetAllAsync();
    //    var relatedOptions = options.Where(qo => qo.QuestionId == questionId);
    //    var response = relatedOptions.Adapt<IEnumerable<QuestionOptionResponse>>();
    //    return Ok(response);
    //}
